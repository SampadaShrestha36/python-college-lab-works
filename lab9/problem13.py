#  Add a new method to the ElectricCar class that calculates the range of the car based on the battery size. The method should print a message indicating the range. 
class Car:
    fuel_level=100
